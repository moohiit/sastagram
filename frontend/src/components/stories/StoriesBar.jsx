...
function StoriesBar() {
  ...
  // Show the right chevron only when the row actually overflows
      ...
      <div className='relative mb-6 pt-4'>
        ...
        >
          ...
          <button
            ...
            className='flex flex-col items-center gap-1 shrink-0 w-[74px] cursor-pointer'
        ...
        {canScrollRight && (
          <button
            ...
            className='absolute right-1 top-[38px] z-10 h-6 w-6 rounded-full bg-gray-100 text-black shadow flex items-center justify-center cursor-pointer'
          >
