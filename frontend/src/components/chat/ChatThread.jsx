    ...
    <div className='flex flex-col h-full min-h-0'>
      <header className='flex items-center gap-3 px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 shrink-0'>
        <button
          ...
          aria-label='Back'
          onClick={onBack}
          className='md:hidden -ml-2 p-1 rounded-lg cursor-pointer hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors'
        >
          <ChevronLeft size={24} />
        </button>
        ...
        <div className='flex flex-col min-w-0'>
          <Link
            ...
            className='text-sm font-semibold text-zinc-900 dark:text-gray-100 truncate hover:underline'
          >
