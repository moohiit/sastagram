              ...
              return (
                ...
                >
                  ...
                  <div className='flex flex-col'>
                    <span className='text-sm font-semibold text-zinc-900 dark:text-gray-100'>{u?.username}</span>
                    <span className='text-xs text-zinc-500 dark:text-zinc-400'>{isOnline ? 'Active now' : 'Offline'}</span>
                  </div>
                </div>
              );
            })
