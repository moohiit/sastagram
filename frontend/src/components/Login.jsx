      ...
      <div className='flex w-full max-w-sm flex-col gap-3'>
        <div className='rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black p-8'>
          ...
          <form onSubmit={loginHandler} noValidate className='flex flex-col gap-4'>
            <div>
              <Label htmlFor='login-email' className='text-sm font-semibold text-zinc-900 dark:text-gray-100'>
                Email
              </Label>
              <Input
                id='login-email'
            ...
            <div>
              <Label htmlFor='login-password' className='text-sm font-semibold text-zinc-900 dark:text-gray-100'>
                Password
              </Label>
              <Input
                id='login-password'
