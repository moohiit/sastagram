...
const EditProfile = () => {
  ...
  return (
    <div className='mx-auto w-full max-w-[470px] px-4 py-6'>
      <h1 className='mb-4 text-xl font-bold text-zinc-900 dark:text-gray-100'>Edit profile</h1>
      <section className='flex flex-col gap-6 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black p-4'>
        {/* Avatar + change photo */}
        <div className='flex items-center justify-between gap-3 rounded-lg bg-zinc-100 dark:bg-zinc-900 p-4'>
          <div className='flex min-w-0 items-center gap-4'>
            ...
            <div className='min-w-0'>
              <p className='truncate text-sm font-semibold text-zinc-900 dark:text-gray-100'>
                <Link to={`/profile/${user?._id}`}>{user?.username}</Link>
              </p>
              {user?.bio ? (
                <p className='truncate text-sm text-zinc-500 dark:text-zinc-400'>{user.bio}</p>
              ) : null}
            </div>
          </div>
          <input
        ...
        {/* Bio */}
        <div>
          <Label htmlFor='edit-bio' className='text-sm font-semibold text-zinc-900 dark:text-gray-100'>
            Bio
          </Label>
          <Textarea
            id='edit-bio'
        ...
        {/* Gender */}
        <div>
          <Label className='text-sm font-semibold text-zinc-900 dark:text-gray-100'>Gender</Label>
          <Select
