  ...
  if (!posts || posts.length === 0) {
    return (
      <div className='flex flex-col items-center justify-center gap-3 py-16'>
        <div className='flex h-14 w-14 items-center justify-center rounded-full border-2 border-zinc-900 dark:border-gray-100'>
          <Camera size={28} strokeWidth={1.5} className='text-zinc-900 dark:text-gray-100' />
        </div>
        <p className='text-base font-semibold text-zinc-900 dark:text-gray-100'>{emptyText}</p>
      </div>
    );
  }
